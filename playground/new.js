...
// const oldDate = Date('August 11, 2025');
// const myDate = new Date('August 11, 2025');
// // console.dir(oldDate);
// // console.dir(myDate);
...
Pizza.prototype.describe = function() {
  ...
  return `Pizza topped with ${toppingList} is for ${this.customer} and contains ${this.slices} slices.`;
};
