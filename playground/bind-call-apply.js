...
const bill = {
  ...
  describe(mealType, drinkType, taxRate) {
    console.log(`Your meal of ${mealType} and drink of ${drinkType} was ${this.calculate(taxRate)}`);
  },
};
...
// call does the same as bind but also calls it right away
const total2 = bill.calculate.call({ total: 500 }, 0.06);
console.log(total2);

const total3 = bill.calculate.apply({ total: 550 }, [0.06]);
console.log(total3);
